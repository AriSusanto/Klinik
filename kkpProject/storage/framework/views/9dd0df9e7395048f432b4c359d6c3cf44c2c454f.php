...
<form  class="m-t" role="form" method="POST" action="<?php echo e(Url('/proses_simpan_pasien_anak')); ?>">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                        <!-- Untuk Nomor Urut-->
                         <?php $i = 1;?> 
                    	<?php $__currentLoopData = $list_anak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baris): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="gradeX">
                        <td><?php echo e($i); ?></td>
                        ...
                        <?php $i++ ?>
                        <td>
                             <form method="post" action="<?php echo e(Url('/hapus_pasien_anak')); ?>">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <form enctype="multipart/form-data" role="form" method="post" action="<?php echo e(Url('/proses_update_pasien_anak')); ?>" class="form-horizontal">
                                                         <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                                                         <input type="hidden" name="id" value="<?php echo e($baris->id); ?>"/>
