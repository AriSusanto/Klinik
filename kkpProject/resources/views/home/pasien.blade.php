...
<form  class="m-t" role="form" method="POST" action="{{ Url('/proses_simpan_pasien') }}">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tr class="gradeX">
                        ...
                        <?php $i++ ?>
                        <td>
                             <form method="post" action="{{ Url('/hapus_pasien') }}">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <form enctype="multipart/form-data" role="form" method="post" action="{{ Url('/proses_update_pasien') }}" class="form-horizontal">
                                                         <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                                                         <input type="hidden" name="id" value="{{ $baris->id }}"/>
